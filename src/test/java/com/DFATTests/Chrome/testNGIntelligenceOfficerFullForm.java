...
public class testNGIntelligenceOfficerFullForm extends BaseClass{
	...
	static String path="/src/test/resources/com/DFATReports/";
	...
	public static void Setup() throws IOException, InterruptedException
	{
		...
		CurrentPath=createDateFolder(path);
		ResultReport=CurrentPath+"Screenshot.html";
		SOHTMLGENERAL(ResultReport);
